...
const About = () => {
  ...
  return (
    <section
      id="about"
      className={` ${mode === "light" ? "bg-[#EAF6F6]" : ""}`}
    >
      {/* about-container */}
      <div className="px-[1rem] py-[1.5rem] lg:px-[3.5rem] lg:py-[4rem] text-center">
        ...
        >
          <img
            ...
            className={`md:w-[300px] md:h-[300px] w-[200px] h-[200px] mx-auto rounded-full border-[5px]  ${
              mode === "light"
                ? " border-[#006ca5]"
                : "hover:border-white border-secondary"
            }`}
          />
        </div>
        ...
        {/* about text */}
        <div
          className="max-w-[700px] mx-auto mt-[1.5rem] md:mt-[1.2rem]"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          <h1 className="text-[1.4rem] md:text-[2rem]  leading-normal">
            <span>Hi, I&apos;m</span>{" "}
            <span className="font-semibold">Udhe Austine Ogaga</span>
          </h1>
          ...
          <div className="flex justify-center gap-[1.5rem] lg:gap-[2rem] mt-[2rem]">
            <Link
              to={
                "https://drive.google.com/file/d/1ueOidrBWSXvapkJ5dSBnCAFj2lrRd6-P/view?usp=drivesdk"
              }
              className={`buttons w-[10rem] md:w-[11.5rem] h-[3.5rem] lg:h-[4rem] font-semibold md:text-[1.25rem] text-[1.1rem] ${
                mode === "dark" ? "dark-bg-buttons" : "light-bg-buttons"
              } rounded-lg`}
            >
